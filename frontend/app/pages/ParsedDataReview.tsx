...
const confidenceIcon = {
  high: <CheckCircle2 className="w-3.5 h-3.5 text-success" />,
  medium: <AlertTriangle className="w-3.5 h-3.5 text-warning" />,
    ...
    <div className="max-w-4xl mx-auto space-y-6 fade-in">
            ...
            <div key={field.label} className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className={cn("text-[10px] font-medium", `confidence-${field.confidence}`)}>
              ...
              {editingIndex === i ? (
                ...
                <div
                  ...
                  onClick={() => field.editable && startEdit(i)}
                >
      ...
      <section className="bg-card border border-border rounded-xl p-6" style={{ boxShadow: "var(--shadow-sm)" }}>
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge variant="outline" className="confidence-high text-xs gap-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <section className="bg-card border border-border rounded-xl p-6" style={{ boxShadow: "var(--shadow-sm)" }}>
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="outline" className="confidence-medium text-xs gap-1">
