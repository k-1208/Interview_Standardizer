      ...
      <div className="space-y-4">
        {mockInterviewHistory.map((h, i) => (
          <div
            ...
            className={cn(
              "bg-card border rounded-xl p-5 cursor-pointer transition-all duration-200 hover:shadow-card relative",
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    {i === 0 && <Badge className="text-[10px] px-1.5 py-0 bg-success/10 text-success border-0">Latest</Badge>}
                  </div>
